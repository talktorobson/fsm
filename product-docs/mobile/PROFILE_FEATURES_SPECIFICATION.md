...
- `docs/IMPLEMENTATION_TRACKING.md` - Overall project progress
- `product-docs/domain/02-provider-capacity-domain.md` - Provider/WorkTeam data model
- `mobile/README.md` - Mobile app architecture
- `docs/MOBILE_APP_ARCHITECTURE.md` - Technical design
