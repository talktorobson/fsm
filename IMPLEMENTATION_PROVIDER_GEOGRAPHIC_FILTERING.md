...
3. **Distance Scoring**
   - Based on product requirements (product-docs/domain/05-assignment-dispatch-logic.md)
   - Scoring ranges:
     - 0-10 km = 20 points
     - 10-30 km = 15 points
     - 30-50 km = 10 points
...
- **Product Requirements**: `product-docs/domain/05-assignment-dispatch-logic.md`
