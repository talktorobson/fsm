...
- `product-docs/architecture/03-service-boundaries.md` (Communication & Notifications Service)
- `product-docs/integration/02-event-schema-registry.md` (Event schemas)
